...
{     Data Criação: 29/03/1999;
  ...
  Data Alteração:
    Alterado por:
Motivo alteração: Adicionado os comementários e os blocos e testado - 29/03/1999 }
...
begin
  ...
  DBRadioGroup1.Controls[1].Enabled := (ConfigModulos.PedidoVenda or  ConfigModulos.OrcamentoVenda);
  DBRadioGroup1.Controls[2].Enabled := ConfigModulos.OrdemServico;
